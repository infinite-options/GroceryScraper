...
for i in range(20):
    items_wholefoods = items_wholefoods + ((response_wholefoods.json()['list'][i]['name']),(response_wholefoods.json()['list'][i]['store']['price']))
...
@app.route("/home")
def home():
    return render_template('home.html', items_wholefoods=items_wholefoods)
